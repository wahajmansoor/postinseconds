...
// LinkedIn's "More" overflow glyph — three dots, used icon-only (no text
// label) on both the profile page's "More" button and the post action bar.
export function LinkedInOverflowIcon({ size = 16, className }: ReactionIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
